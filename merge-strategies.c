...
{
	/*
	 * The first head being merged was a fast-forward.  Advance the reference
	 * commit to the head being merged, and use that tree as the intermediate
	 * result of the merge.  We still need to count this as part of the parent
	 * set.
	 */
